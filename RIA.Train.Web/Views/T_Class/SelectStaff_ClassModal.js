...
(function () {
    $(function () {
            ...
            fields: {
                ...
                if ($selectedRows.length > 0) {
                    ...
                    $selectedRows.each(function () {
                        ...
                        selectRow.push({ FK_ClassId: fk_Id, FK_UserId: record.id, UserName: record.staffName });
        ...
        app.modals.SelectStaff_ClassModal = function () {

            var _modalManager;

            var _t_StaffService = abp.services.app.t_HClass;
            ...
            this.save = function () {
                ...
                _t_StaffService.batchCreateOrUpdateT_HClassAsync({
                    T_HClassEditDto: selectRow
                }).done(function () {
                    //提示信息
