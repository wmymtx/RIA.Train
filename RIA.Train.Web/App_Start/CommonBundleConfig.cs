...
namespace RIA.Train.Web
{
    public static class CommonBundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(
                new StyleBundle("~/Bundles/CommonRes/css")
                    .IncludeDirectory("~/CommonRes/Styles", "*.css", true)
                   
                );

            bundles.Add(
                new ScriptBundle("~/Bundles/CommonRes/js")
                    .IncludeDirectory("~/CommonRes/Scripts", "*.js", true)
        ...
        private static void AddFrontendCssLibs(BundleCollection bundles, bool isRTL)
        {
            bundles.Add(
                new StyleBundle("~/Bundles/Frontend/libs/css" + (isRTL ? "RTL" : ""))
                    ...
                    .Include(StylePaths.Toastr).Include(StylePaths.JQuery_jTable_Theme).Include(StylePaths.JsTree)
                    .ForceOrdered()
                );
        }
