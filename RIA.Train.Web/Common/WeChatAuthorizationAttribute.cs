...
namespace RIA.Train.Web.Common
{
    ...
    public class WeChatAuthorizationAttribute: FilterAttribute, IAuthorizationFilter
    {
        public static ILogger Logger { get; set; }
        /// <summary>
        /// 默认构造函数
        /// </summary>
        public WeChatAuthorizationAttribute()
        {
            Logger = NullLogger.Instance;
            String authUrl = AbpWebConst.AuthUrl;
            String saveKey = AbpWebConst.AuthSaveKey;
            String saveType = AbpWebConst.AuthSaveType;
        ...
        public WeChatAuthorizationAttribute(String authUrl) : this()
        {
            this._AuthUrl = authUrl;
        }
        /// <summary>
        ...
        public WeChatAuthorizationAttribute(String authUrl, String saveKey) : this(authUrl)
        {
        ...
        public WeChatAuthorizationAttribute(String authUrl, String saveKey, String saveType)
