...
T_Estimate_DetailManage t_Estimate_DetailManage
        ...
        public T_Estimate_DetailListDto GetT_Estima_DetailteById(int id, int userId)
        {
            var entity = _t_Estimate_DetailRepository.GetAll().FirstOrDefault(o => o.FK_EstimateId == id && o.FK_TstaffId == userId);
