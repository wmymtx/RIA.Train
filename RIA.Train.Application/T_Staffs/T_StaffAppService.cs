...
T_StaffManage t_StaffManage
        ...
        public T_StaffEditDto ValidateUser(int loginNo, string password)
        {
            var query = _t_StaffRepository.GetAll().FirstOrDefault(o => o.LoginNo == loginNo && o.PassWord == password);
            return query.MapTo<T_StaffEditDto>();
