...
T_KPointManage t_KPointManage
        ...
        public async Task<PagedResultDto<T_KPointListDto>> GetPagedT_KPointsAsync(GetT_KPointInput input)
        {
            ...
            //return new JtableResult<List<T_KPointListDto>>(t_KPointCount, t_KPointListDtos);
        }

        public async Task<PagedResultDto<T_KPointListDto>> GetPagedT_KPointsByItemIdAsync(GetT_KPointInput input)
        {
            ...
            var t_KPoints = await query
           .Where(o => o.Fk_Item_KPoint_Id == input.Id)
            .ToListAsync();
            ...
            // return new JtableResult<List<T_KPointListDto>>(100, t_KPointListDtos);
        }
