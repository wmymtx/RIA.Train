...
namespace RIA.Train.Application.Mappers
{
    ...
    private static volatile bool _mappedBefore;
	    ...
	    /// <summary>
       ///    Configuration.Modules.AbpAutoMapper().Configurators.Add(T_ItemDtoMapper.CreateMappings);
    ...
    /// </summary>       
	  ...
	  // Configuration.Modules.AbpAutoMapper().Configurators.Add(T_ItemDtoMapper.CreateMappings);
	    ...
	    //    Mapper.CreateMap<T_Item,T_ItemEditDto>();
       //     Mapper.CreateMap<T_Item, T_ItemListDto>();

     //       Mapper.CreateMap<T_ItemEditDto, T_Item>();
    //        Mapper.CreateMap<T_ItemListDto,T_Item>();
