...
namespace RIA.Train.Application.Mappers
{
    ...
    private static volatile bool _mappedBefore;
	    ...
	    /// <summary>
       ///    Configuration.Modules.AbpAutoMapper().Configurators.Add(T_GroupDtoMapper.CreateMappings);
    ...
    /// </summary>       
	  ...
	  // Configuration.Modules.AbpAutoMapper().Configurators.Add(T_GroupDtoMapper.CreateMappings);
	    ...
	    //    Mapper.CreateMap<T_Group,T_GroupEditDto>();
       //     Mapper.CreateMap<T_Group, T_GroupListDto>();

     //       Mapper.CreateMap<T_GroupEditDto, T_Group>();
    //        Mapper.CreateMap<T_GroupListDto,T_Group>();
