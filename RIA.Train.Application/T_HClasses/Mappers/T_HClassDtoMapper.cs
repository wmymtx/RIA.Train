...
namespace RIA.Train.Application.Mappers
{
    ...
    /// T_HClassDto映射配置
    /// </summary>
    public class T_HClassDtoMapper 
    {
    ...
    private static volatile bool _mappedBefore;
	    ...
	    /// <summary>
       ///    Configuration.Modules.AbpAutoMapper().Configurators.Add(T_HClassDtoMapper.CreateMappings);
    ...
    /// </summary>       
	  ...
	  // Configuration.Modules.AbpAutoMapper().Configurators.Add(T_HClassDtoMapper.CreateMappings);
	    ...
	    //    Mapper.CreateMap<T_HClass,T_HClassEditDto>();
       //     Mapper.CreateMap<T_HClass, T_HClassListDto>();

     //       Mapper.CreateMap<T_HClassEditDto, T_HClass>();
    //        Mapper.CreateMap<T_HClassListDto,T_HClass>();
