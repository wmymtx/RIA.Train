...
namespace RIA.Train.Application.Mappers
{
    ...
    /// T_RequireDto映射配置
    /// </summary>
    public class T_RequireDtoMapper 
    {
    ...
    private static volatile bool _mappedBefore;
	    ...
	    /// <summary>
       ///    Configuration.Modules.AbpAutoMapper().Configurators.Add(T_RequireDtoMapper.CreateMappings);
    ...
    /// </summary>       
	  ...
	  // Configuration.Modules.AbpAutoMapper().Configurators.Add(T_RequireDtoMapper.CreateMappings);
	    ...
	    //    Mapper.CreateMap<T_Require,T_RequireEditDto>();
       //     Mapper.CreateMap<T_Require, T_RequireListDto>();

     //       Mapper.CreateMap<T_RequireEditDto, T_Require>();
    //        Mapper.CreateMap<T_RequireListDto,T_Require>();
